...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright IlyaVarabei, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/DistortionEffect-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DistortionEffect-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DistortionEffect-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DistortionEffect-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DistortionEffect-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DistortionEffect-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/DistortionEffect-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/DistortionEffect.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/DistortionEffect.iss",inplace=1):
