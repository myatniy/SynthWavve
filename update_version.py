...
def main():
  ...
  plistpath = scriptpath + "/resources/SynthWavve-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SynthWavve-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SynthWavve-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SynthWavve-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SynthWavve-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SynthWavve-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/SynthWavve-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/SynthWavve.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SynthWavve.iss",inplace=1):
